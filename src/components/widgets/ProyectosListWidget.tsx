          ...
          : proyectos.map((proyecto, indice) => {
            ...
            return (
              <motion.button
                ...
                whileHover={{ x: 2 }}
                className="flex items-center gap-2.5 py-2 border-b border-[#F5F5F3] last:border-0 text-left w-full"
              >
                <div
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-[12px] font-bold text-[#111] truncate">{proyecto.nombre}</div>
                ...
                <div className="flex flex-col items-end gap-1 flex-shrink-0 w-14">
                  <span
                    className="font-black text-[11px] text-[#111]"
                    style={{ fontFamily: 'var(--font-nunito)' }}
                  >
                    {proyecto.progreso}%
                  </span>
